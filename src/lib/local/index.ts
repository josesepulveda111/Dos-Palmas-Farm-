import {
  ...
  } from "@/lib/local/mutations/cart";
  import {
    createCustomerMutation,
    getCustomerAccessTokenMutation,
    getUserDetailsQuery,
  } from "./mutations/customer";
  import { getCartQuery } from "@/lib/local/queries/cart";
  import {
    getCollectionProductsQuery,
    getCollectionQuery,
    getCollectionsQuery,
  } from "@/lib/local/queries/collection";
  import { getMenuQuery } from "@/lib/local/queries/menu";
  import { getPageQuery, getPagesQuery } from "@/lib/local/queries/page";
  import {
    getHighestProductPriceQuery,
    getProductQuery,
    getProductRecommendationsQuery,
    getProductsQuery,
  } from "@/lib/local/queries/product";
  import { getVendorsQuery } from "@/lib/local/queries/vendor";
  import type {
    Cart,
    Collection,
    Connection,
